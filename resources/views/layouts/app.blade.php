                            ...
                            <div class="modal-content">
                                ...
                                <form id="jobform">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="technology[]" id="single_tech" multiple>
                                        </select>
...
{{-- Note Modal Start --}}
    ...
    {
         $('#technology').val(null).trigger('change');
        var all_tech='';
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('#technology,#student_technology,#single_tech').append(all_tech);
            }
        });
    }
    // Fetch State
    ...
    $('.dropdown-item').on('click',function(e){
         $('#student_technology,#single_tech').val(null).trigger('change');
