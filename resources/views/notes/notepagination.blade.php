...
<div class="table-responsive" id="notedata">
    ...
    <tbody align="center">
        ...
        <tr>
            ...
            <td>
                <!-- <div class="checkbox"> -->
                <input type="checkbox" class="checkbox-input favourite" data-id="{{$note->id}}" id="checkbox{{$index}}" @if($note->favourite)checked @endif>
        ...
        @empty
            <tr>
                <td colspan="6"><h2>No Data Found</h2></td>
            </tr>
        @endforelse
    </tbody>
</table>
