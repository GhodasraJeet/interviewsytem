...
<div id="show"></div>
<div class="float-right mt-2 w-25 mr-2">
    <div class="form-group">
        <input type="text" class="form-control " placeholder="Search Here" id="studentnamesearch">        
    </div>
</div>
<div id="contain"></div>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.success,function(key,value){
                    ...
                    if(value.state_id==2){
                        hr_round.push({id:value.id,title:value.name,border:'dark',dueDate:tech});
                    }
                    if(value.state_id==3){
                        technical.push({id:value.id,title:value.name,border:'secondary',dueDate:tech});
                    }
                    if(value.state_id==4){
                        practical.push({id:value.id,title:value.name,border:'success',dueDate:tech});
                    }
                    if(value.state_id==5){
                        offered.push({id:value.id,title:value.name,border:'warning',dueDate:tech});
                    }
                    if(value.state_id==6){
                        rejected.push({id:value.id,title:value.name,border:'info',dueDate:tech});
                    }
                    if(value.state_id==7){
                        hold.push({id:value.id,title:value.name,border:'danger',dueDate:tech});
                    }
                });
                allStudent.push({id:"kanban-board-1",title:"",item:new_applicant});
                allStudent.push({id:"kanban-board-2",title:"",item:hr_round});
                allStudent.push({id:"kanban-board-3",title:"",item:technical});
                allStudent.push({id:"kanban-board-4",title:"",item:practical});
                allStudent.push({id:"kanban-board-5",title:"",item:offered});
                allStudent.push({id:"kanban-board-6",title:"",item:rejected});
                allStudent.push({id:"kanban-board-7",title:"",item:hold});
                ...
                $('[data-id=kanban-board-1]').prepend("<h5 class='text-center'>New Applicant</h5><div class='customline mb-2'></div>");
                $('[data-id=kanban-board-2]').prepend("<h5 class='text-center'>HR Round</h5><div class='customline mb-2'></div>");
                $('[data-id=kanban-board-3]').prepend("<h5 class='text-center'>Technical</h5><div class='customline mb-2'></div>");
                $('[data-id=kanban-board-4]').prepend("<h5 class='text-center'>Practical</h5><div class='customline mb-2'></div>");
                $('[data-id=kanban-board-5]').prepend("<h5 class='text-center'>Offered</h5><div class='customline mb-2'></div>");
                $('[data-id=kanban-board-6]').prepend("<h5 class='text-center'>Rejected</h5><div class='customline mb-2'></div>");
                $('[data-id=kanban-board-7]').prepend("<h5 class='text-center'>Hold</h5><div class='customline mb-2'></div>");
